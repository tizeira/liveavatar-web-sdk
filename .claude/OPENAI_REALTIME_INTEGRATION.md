...
1. [x] Crear `/api/openai-realtime/route.ts`
2. [x] Crear `useOpenAIRealtimeAgent.ts` estructura base
3. [x] Verificar OPENAI_API_KEY funciona

### Fase 2: Audio Pipeline ✅

4. [x] Implementar captura de micrófono a 24kHz (resample en hook)
5. [x] Implementar envío de audio chunks
6. [x] Implementar recepción de audio (ya 24kHz!)

### Fase 3: Integración ✅

7. [x] Conectar hook con ClaraVoiceAgent
8. [x] Audio output ya es 24kHz - no necesita resample adicional
9. [x] Mapear eventos OpenAI → callbacks existentes
...
15. [ ] ElevenLabs mantenido como backup en codebase
16. [x] Actualizar documentación
17. [x] Actualizar feature_list.json
